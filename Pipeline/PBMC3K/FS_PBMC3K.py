...
# recon 3D
recon3D = cobra.io.load_matlab_model('/home/claudia/Recon3DModel_301.mat')
...
f_path = "/home/claudia/PBMC/PBMC_Models/"
...
fba_fluxes_df.to_csv('/home/claudia/PBMC/results/fba_fluxes_pbmc3k.csv')
print("fluxes dfs have been stored")

fba_r_models.to_csv('/home/claudia/PBMC/results/fba_rmodels_pbmc3k.csv')
pfba_r_models.to_csv('/home/claudia/PBMC/results/pfba_rmodels_pbmc3k.csv')
